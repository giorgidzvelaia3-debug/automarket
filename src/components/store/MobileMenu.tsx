      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-2">
          ...
          <div className="mt-3 pt-3 border-t border-gray-100 px-3">
            ...
            <div className={`space-y-0.5 overflow-hidden transition-all duration-200 ${catOpen ? "max-h-[2000px] opacity-100" : "max-h-0 opacity-0"}`}>
              {categories.map((cat) => (
                <div key={cat.id}>
                  <div className="flex items-center">
                    <Link
                      ...
                      onClick={onClose}
                      className="flex-1 block px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg transition-colors pl-6"
                    >
                    ...
                    {cat.children.length > 0 && (
                      ...
                      >
                        <svg
                          className={`w-3.5 h-3.5 transition-transform duration-200 ${expandedCat === cat.id ? "rotate-180" : ""}`}
                          fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}
                        >
                          <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                        </svg>
                  ...
                  {cat.children.length > 0 && expandedCat === cat.id && (
                    <div className="ml-6 space-y-0.5">
                      {cat.children.map((sub) => (
                        <Link
                          ...
                          onClick={onClose}
                          className="block px-3 py-2 text-sm text-gray-500 hover:bg-gray-50 rounded-lg transition-colors pl-6"
                        >
